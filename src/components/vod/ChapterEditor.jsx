  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 text-sm text-white/70">
        <BookOpen className="w-4 h-4 text-[#4A8A7A]" />
      ...
      <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
        ...
        {chapters.map((ch, i) => (
          <div key={i} className="flex items-center gap-3 bg-white/5 rounded-xl px-3 py-2">
            <span className="text-[#4A8A7A] font-mono text-xs w-10 shrink-0">{fmt(ch.time)}</span>
      ...
      <div className="flex gap-2 pt-1">
        ...
        <button
          ...
          style={{
            ...
            background: '#4A8A7A', color: '#000', border: 'none',
          }}
        >
