    ...
    <>
      ...
      {zegoRoomId && !connecting && goLiveMut.isSuccess && (
        <div className="mt-2 flex items-center gap-2 px-3 py-1.5 rounded-lg" style={{ background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(0,245,255,0.15)' }}>
          <span className="text-[8px] uppercase font-black" style={{ color: 'rgba(255,255,255,0.2)', ...T }}>Stream Session</span>
          <span className="text-[9px] flex-1 truncate" style={{ color: '#00F5FF', fontFamily: 'Share Tech Mono, monospace' }}>{zegoRoomId}</span>
