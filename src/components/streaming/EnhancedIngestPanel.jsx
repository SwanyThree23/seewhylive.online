      ...
      <div>
        ...
        <div style={{ padding:16 }} className="space-y-4">
          ...
          {activeTab === 'rtmp' && <div className="space-y-3">
            <div className="bg-[#0F1428]/50 border border-[#d4af37]/15 rounded-lg p-3">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 rounded bg-gradient-to-br from-blue-500 to-[#4A8A7A] flex items-center justify-center text-xs font-bold text-white">⚡</div>
          ...
          {activeTab === 'whip' && <div className="space-y-3">
            <div className="bg-[#0F1428]/50 border border-[#d4af37]/15 rounded-lg p-3">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 rounded bg-gradient-to-br from-red-500 via-yellow-500 to-[#6DBF7E] flex items-center justify-center text-xs font-bold text-white">W</div>
