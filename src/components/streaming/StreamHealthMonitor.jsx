...
export default function StreamHealthMonitor({ isStreaming = false }) {
  ...
  if (!isStreaming) return (
    <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg"
      ...
      <span className="text-[11px] font-bold text-white/25" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>OFFLINE</span>
    </div>
  );
  ...
  return (
    <div className="flex items-center gap-2 px-2 py-1 rounded-lg"
      ...
      <span className="text-[11px] font-black" style={{ color: qualityColor, fontFamily: 'Barlow Condensed, sans-serif' }}>
        {stats.quality.toUpperCase()}
      </span>
      <span className="text-[11px] text-white/40" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
