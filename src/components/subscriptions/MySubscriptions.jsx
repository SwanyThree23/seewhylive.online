...
const statusColors = {
  active:    { background: 'rgba(34,197,94,0.15)',  color: '#6DBF7E',           border: '1px solid rgba(34,197,94,0.3)' },
  cancelled: { background: 'rgba(239,68,68,0.15)',  color: '#C0392B',           border: '1px solid rgba(239,68,68,0.3)' },
          ...
          <div style={{ background: 'rgba(13,6,24,0.95)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 16, fontFamily: 'Barlow Condensed, sans-serif' }}>
            ...
            {sub.status === 'active' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flexShrink: 0 }}>
                ...
                <button
                  style={{ fontSize: 12, height: 28, padding: '0 10px', background: 'transparent', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 6, color: '#C0392B', cursor: cancelMutation.isPending ? 'not-allowed' : 'pointer', opacity: cancelMutation.isPending ? 0.6 : 1, fontFamily: 'Barlow Condensed, sans-serif' }}
