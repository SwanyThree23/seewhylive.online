...
Write an engaging summary that captures the energy of the stream. Include highlights if chat shows them. End with a hype call-to-action. Keep it under 100 words.`,
  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.2)' }}>
      <div className="flex items-center justify-between px-3 py-2" style={{ borderBottom: '1px solid rgba(139,92,246,0.12)' }}>
        <div className="flex items-center gap-1.5">
          <Sparkles className="w-3.5 h-3.5" style={{ color: '#8B5CF6' }} />
          <span className="text-[11px] font-black uppercase tracking-wider" style={{ color: '#8B5CF6', fontFamily: 'Barlow Condensed, sans-serif' }}>
            AI Stream Summary
          </span>
        </div>
        <Button
        ...
        {summary && (
          <motion.div
            ...
            <button
              ...
              style={{ color: copied ? '#00FF88' : 'rgba(139,92,246,0.7)' }}>
