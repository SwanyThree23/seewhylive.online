          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1, maxWidth: 448, width: '100%', background: '#0A0710', border: '1px solid rgba(212,175,55,0.2)', borderRadius: 16, padding: 24, color: '#fff' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                ...
                <button onClick={() => setOpen(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.4)', display: 'flex', alignItems: 'center' }}>
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="flex gap-2 pt-3">
                <button
                  ...
                  className="flex-1 bg-[#d4af37] text-black hover:bg-[#e6c158]"
                  style={{ padding: '8px 16px', borderRadius: 8, border: 'none', cursor: 'pointer', fontWeight: 700, fontFamily: 'Barlow Condensed, sans-serif' }}
                >
                  Done
                </button>
              </div>
