...
Now let me address the lint errors. There are many across different files. Let me batch-read the ones with syntax/parse errors (which block the build) and the missing imports.
